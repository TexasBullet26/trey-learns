# Realworld Fullstack App API Spec
...
For more details, see [`run-api-tests.sh`](https://github.com/TexasBullet26/trey-learns/blob/master/computer-science/projects/realworld-fullstack-app/api/run-api-tests.sh)

## Considerations for Node/Express backend with [CORS](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing)
