    ...
    return (
        <div className='social-icons animate-icons'>
            <a
                ...
                href='https://github.com/TexasBullet26'
            ...
            <a
                target='_blank'
                rel='noopener noreferrer'
                href='https://twitter.com/lanzergiii'
                style={{ color: colorPrimary }}
            >
            ...
            <a
                target='_blank'
                rel='noopener noreferrer'
                href='https://stackoverflow.com/story/texasbullet26'
                style={{ color: colorPrimary }}
            >
            ...
            <a
                target='_blank'
                rel='noopener noreferrer'
                href='https://www.linkedin.com/in/glenn-lanzer'
                style={{ color: colorPrimary }}
            >
            ...
            <a
                target='_blank'
                rel='noopener noreferrer'
                href='https://medium.com/@texasbullet26'
                style={{ color: colorPrimary }}
            >
            ...
            <a 
                ...
                target='_blank' 
                rel='noopener noreferrer' 
                href='https://dev.to/texasbullet26'
            >
